...
static inline uint32_t SCG_GetClockoutSourceSel(const SCG_Type *base) {
	return (base->CLKOUTCNFG & SCG_CLKOUTCNFG_CLKOUTSEL_MASK)
 ...
 */
static inline void SCG_SetRunClockControl(SCG_Type *base, uint32_t source,
		uint32_t coreDivider, uint32_t busDivider, uint32_t slowDivider) {
	uint32_t value = (uint32_t) (((source << SCG_RCCR_SCS_SHIFT)
			& SCG_RCCR_SCS_MASK)
 ...
 * @param[in] base System clock configuration address.
 */
static inline void SCG_SetVlprClockControl(SCG_Type *base, uint32_t source,
		uint32_t coreDivider, uint32_t busDivider, uint32_t slowDivider) {
	uint32_t value = (uint32_t) (((source << SCG_VCCR_SCS_SHIFT)
			& SCG_VCCR_SCS_MASK)
 ...
 * @param[in] base System clock configuration address.
 */
static inline void SCG_SetHsrunClockControl(SCG_Type *base, uint32_t source,
		uint32_t coreDivider, uint32_t busDivider, uint32_t slowDivider) {
	uint32_t value = (uint32_t) (((source << SCG_HCCR_SCS_SHIFT)
			& SCG_HCCR_SCS_MASK)
...
static inline uint32_t SCG_GetFircFirstAsyncDivider(const SCG_Type *base) {
	return (base->FIRCDIV & SCG_FIRCDIV_FIRCDIV1_MASK)
...
static inline uint32_t SCG_GetFircSecondAsyncDivider(const SCG_Type *base) {
	return (base->FIRCDIV & SCG_FIRCDIV_FIRCDIV2_MASK)
 ...
 */
static inline void SCG_SetFircAsyncConfig(SCG_Type *base, uint32_t div1,
		uint32_t div2) {
	uint32_t value =
			(uint32_t) (((div1 << SCG_FIRCDIV_FIRCDIV1_SHIFT)
					& SCG_FIRCDIV_FIRCDIV1_MASK)
					| ((div2 << SCG_FIRCDIV_FIRCDIV2_SHIFT)
...
static inline uint32_t SCG_GetSircFirstAsyncDivider(const SCG_Type *base) {
	return (base->SIRCDIV & SCG_SIRCDIV_SIRCDIV1_MASK)
...
static inline uint32_t SCG_GetSircSecondAsyncDivider(const SCG_Type *base) {
	return (base->SIRCDIV & SCG_SIRCDIV_SIRCDIV2_MASK)
 ...
 * @param[in] base Asynchronous second divider
 */
static inline void SCG_SetSircAsyncConfig(SCG_Type *base, uint32_t div1,
		uint32_t div2) {
	uint32_t value =
			(uint32_t) (((div1 << SCG_SIRCDIV_SIRCDIV1_SHIFT)
					& SCG_SIRCDIV_SIRCDIV1_MASK)
					| ((div2 << SCG_SIRCDIV_SIRCDIV2_SHIFT)
...
static inline uint32_t SCG_GetSoscFirstAsyncDivider(const SCG_Type *base) {
	return (base->SOSCDIV & SCG_SOSCDIV_SOSCDIV1_MASK)
...
static inline uint32_t SCG_GetSoscSecondAsyncDivider(const SCG_Type *base) {
	return (base->SOSCDIV & SCG_SOSCDIV_SOSCDIV2_MASK)
 ...
 * @param[in] base Asynchronous second divider
 */
static inline void SCG_SetSoscAsyncConfig(SCG_Type *base, uint32_t div1,
		uint32_t div2) {
	uint32_t value =
			(uint32_t) (((div1 << SCG_SOSCDIV_SOSCDIV1_SHIFT)
					& SCG_SOSCDIV_SOSCDIV1_MASK)
					| ((div2 << SCG_SOSCDIV_SOSCDIV2_SHIFT)
...
static inline uint32_t SCG_GetSpllFirstAsyncDivider(const SCG_Type *base) {
	return (base->SPLLDIV & SCG_SPLLDIV_SPLLDIV1_MASK)
...
static inline uint32_t SCG_GetSpllSecondAsyncDivider(const SCG_Type *base) {
	return (base->SPLLDIV & SCG_SPLLDIV_SPLLDIV2_MASK)
 ...
 * @param[in] base Asynchronous second divider
 */
static inline void SCG_SetSpllAsyncConfig(SCG_Type *base, uint32_t div1,
		uint32_t div2) {
	uint32_t value =
			(uint32_t) (((div1 << SCG_SPLLDIV_SPLLDIV1_SHIFT)
					& SCG_SPLLDIV_SPLLDIV1_MASK)
					| ((div2 << SCG_SPLLDIV_SPLLDIV2_SHIFT)
...
static inline bool SCG_GetSircSystemClockMode(const SCG_Type *const base) {
	...
	regValue = (regValue & SCG_SIRCCSR_SIRCSEL_MASK)
...
static inline bool SCG_GetSircStatus(const SCG_Type *const base) {
	return (((base->SIRCCSR & SCG_SIRCCSR_SIRCVLD_MASK)
			>> SCG_SIRCCSR_SIRCVLD_SHIFT) != 0U) ? true : false;
}
 ...
 */
static inline void SCG_SetSircControl(SCG_Type *base, bool enableInStop,
		bool enableInLowPower, bool lockMode) {
...
static inline bool SCG_GetFircSystemClockMode(const SCG_Type *const base) {
	...
	regValue = (regValue & SCG_FIRCCSR_FIRCSEL_MASK)
...
static inline bool SCG_GetFircStatus(const SCG_Type *const base) {
	return (((base->FIRCCSR & SCG_FIRCCSR_FIRCVLD_MASK)
			>> SCG_FIRCCSR_FIRCVLD_SHIFT) != 0U) ? true : false;
}
 ...
 * @param[in] lockMode    control register can be written or not
 */
static inline void SCG_SetFircControl(SCG_Type *base, bool regulator,
		bool lockMode) {
...
static inline bool SCG_GetSoscSystemClockMode(const SCG_Type *const base) {
	...
	regValue = (regValue & SCG_SOSCCSR_SOSCSEL_MASK)
...
static inline bool SCG_GetSoscStatus(const SCG_Type *const base) {
	return (((base->SOSCCSR & SCG_SOSCCSR_SOSCVLD_MASK)
			>> SCG_SOSCCSR_SOSCVLD_SHIFT) != 0U) ? true : false;
}
 ...
 */
static inline void SCG_SetSoscConfiguration(SCG_Type *base, uint32_t range,
		uint32_t gain, uint32_t extRef) {
 ...
 * @param[in] lockMode    control register can be written or not
 */
static inline void SCG_SetSoscControl(SCG_Type *base, bool monitorMode,
		bool resetMode, bool lockMode) {
...
static inline bool SCG_GetSpllSystemClockMode(const SCG_Type *const base) {
	...
	regValue = (regValue & SCG_SPLLCSR_SPLLSEL_MASK)
...
static inline bool SCG_GetSpllStatus(const SCG_Type *const base) {
	return (((base->SPLLCSR & SCG_SPLLCSR_SPLLVLD_MASK)
			>> SCG_SPLLCSR_SPLLVLD_SHIFT) != 0U) ? true : false;
}
...
static inline uint32_t SCG_GetSpllPredivider(const SCG_Type *const base) {
	return ((base->SPLLCFG & SCG_SPLLCFG_PREDIV_MASK)
 ...
 */
static inline void SCG_SetSpllConfiguration(SCG_Type *base, uint8_t divider,
		uint8_t multiplier) {
	/* Set PLL configuration. */
	base->SPLLCFG = SCG_SPLLCFG_PREDIV(divider) | SCG_SPLLCFG_MULT(multiplier);
}
 ...
 * @param[in] lockMode    control register can be written or not
 */
static inline void SCG_SetSpllControl(SCG_Type *base, bool monitorMode,
		bool resetMode, bool lockMode) {
