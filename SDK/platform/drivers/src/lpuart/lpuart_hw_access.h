 ...
 */
typedef enum {
	LPUART_TX_DATA_REG_EMPTY = (((uint32_t) LPUART_STAT_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_STAT_TDRE_SHIFT),
	/*!< Tx data register empty flag, sets when Tx buffer is empty */
	LPUART_TX_COMPLETE = (((uint32_t) LPUART_STAT_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_STAT_TC_SHIFT),
	/*!< Transmission complete flag, sets when transmission activity complete */
	LPUART_RX_DATA_REG_FULL = (((uint32_t) LPUART_STAT_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_STAT_RDRF_SHIFT),
	/*!< Rx data register full flag, sets when the receive data buffer is full */
	LPUART_IDLE_LINE_DETECT = (((uint32_t) LPUART_STAT_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_STAT_IDLE_SHIFT),
	/*!< Idle line detect flag, sets when idle line detected */
	LPUART_RX_OVERRUN = (((uint32_t) LPUART_STAT_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_STAT_OR_SHIFT),
	/*!< Rx Overrun sets if new data is received before data is read */
	LPUART_NOISE_DETECT = (((uint32_t) LPUART_STAT_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_STAT_NF_SHIFT),
	/*!< Rx takes 3 samples of each received bit. If these differ, the flag sets */
	LPUART_FRAME_ERR = (((uint32_t) LPUART_STAT_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_STAT_FE_SHIFT),
	/*!< Frame error flag, sets if logic 0 was detected where stop bit expected */
	LPUART_PARITY_ERR = (((uint32_t) LPUART_STAT_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_STAT_PF_SHIFT),
	/*!< If parity enabled, sets upon parity error detection */
	LPUART_LIN_BREAK_DETECT = (((uint32_t) LPUART_STAT_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_STAT_LBKDIF_SHIFT),
	/*!< LIN break detect interrupt flag, sets when LIN break char detected */
	LPUART_RX_ACTIVE_EDGE_DETECT = (((uint32_t) LPUART_STAT_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_STAT_RXEDGIF_SHIFT),
	/*!< Rx pin active edge interrupt flag, sets when active edge detected */
	LPUART_RX_ACTIVE = (((uint32_t) LPUART_STAT_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_STAT_RAF_SHIFT),
	/*!< Receiver Active Flag (RAF), sets at beginning of valid start bit */
	LPUART_NOISE_IN_CURRENT_WORD = (((uint32_t) LPUART_DATA_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_DATA_NOISY_SHIFT),
	/*!< NOISY bit, sets if noise detected in current data word */
	LPUART_PARITY_ERR_IN_CURRENT_WORD = (((uint32_t) LPUART_DATA_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_DATA_PARITYE_SHIFT),
	/*!< PARITYE bit, sets if noise detected in current data word */
#if FEATURE_LPUART_HAS_ADDRESS_MATCHING
	LPUART_MATCH_ADDR_ONE = (((uint32_t) LPUART_STAT_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_STAT_MA1F_SHIFT),
	/*!< Address one match flag */
	LPUART_MATCH_ADDR_TWO = (((uint32_t) LPUART_STAT_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_STAT_MA2F_SHIFT),
	/*!< Address two match flag */
#endif
#if FEATURE_LPUART_FIFO_SIZE > 0U
	LPUART_FIFO_TX_OF = (((uint32_t) LPUART_FIFO_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_FIFO_TXOF_SHIFT),
	/*!< Transmitter FIFO buffer overflow */
	LPUART_FIFO_RX_UF = (((uint32_t) LPUART_FIFO_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_FIFO_RXUF_SHIFT)
...
typedef enum {
	LPUART_INT_LIN_BREAK_DETECT = (((uint32_t) LPUART_BAUD_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_BAUD_LBKDIE_SHIFT), /*!< LIN break detect. */
	LPUART_INT_RX_ACTIVE_EDGE = (((uint32_t) LPUART_BAUD_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_BAUD_RXEDGIE_SHIFT), /*!< RX Active Edge. */
	LPUART_INT_TX_DATA_REG_EMPTY = (((uint32_t) LPUART_CTRL_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_CTRL_TIE_SHIFT), /*!< Transmit data register empty. */
	LPUART_INT_TX_COMPLETE = (((uint32_t) LPUART_CTRL_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_CTRL_TCIE_SHIFT), /*!< Transmission complete. */
	LPUART_INT_RX_DATA_REG_FULL = (((uint32_t) LPUART_CTRL_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_CTRL_RIE_SHIFT), /*!< Receiver data register full. */
	LPUART_INT_IDLE_LINE = (((uint32_t) LPUART_CTRL_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_CTRL_ILIE_SHIFT), /*!< Idle line. */
	LPUART_INT_RX_OVERRUN = (((uint32_t) LPUART_CTRL_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_CTRL_ORIE_SHIFT), /*!< Receiver Overrun. */
	LPUART_INT_NOISE_ERR_FLAG = (((uint32_t) LPUART_CTRL_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_CTRL_NEIE_SHIFT), /*!< Noise error flag. */
	LPUART_INT_FRAME_ERR_FLAG = (((uint32_t) LPUART_CTRL_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_CTRL_FEIE_SHIFT), /*!< Framing error flag. */
	LPUART_INT_PARITY_ERR_FLAG = (((uint32_t) LPUART_CTRL_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_CTRL_PEIE_SHIFT), /*!< Parity error flag. */
#if FEATURE_LPUART_HAS_ADDRESS_MATCHING
	LPUART_INT_MATCH_ADDR_ONE = (((uint32_t) LPUART_CTRL_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_CTRL_MA1IE_SHIFT), /*!< Match address one flag. */
	LPUART_INT_MATCH_ADDR_TWO = (((uint32_t) LPUART_CTRL_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_CTRL_MA2IE_SHIFT), /*!< Match address two flag. */
#endif
#if FEATURE_LPUART_FIFO_SIZE > 0U
	LPUART_INT_FIFO_TXOF = (((uint32_t) LPUART_FIFO_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_FIFO_TXOFE_SHIFT), /*!< Transmitter FIFO buffer interrupt */
	LPUART_INT_FIFO_RXUF = (((uint32_t) LPUART_FIFO_REG_ID
			<< (uint32_t) LPUART_SHIFT) | (uint32_t) LPUART_FIFO_RXUFE_SHIFT) /*!< Receiver FIFO buffer interrupt */
#endif
} lpuart_interrupt_t;
...
static inline void LPUART_SetTransmitterCmd(LPUART_Type *base, bool enable) {
	base->CTRL = (base->CTRL & ~LPUART_CTRL_TE_MASK)
			| ((enable ? 1UL : 0UL) << LPUART_CTRL_TE_SHIFT);
...
static inline void LPUART_SetReceiverCmd(LPUART_Type *base, bool enable) {
	base->CTRL = (base->CTRL & ~LPUART_CTRL_RE_MASK)
			| ((enable ? 1UL : 0UL) << LPUART_CTRL_RE_SHIFT);
	/* Wait for the register write operation to complete */
 ...
 */
static inline void LPUART_SetBaudRateDivisor(LPUART_Type *base,
 ...
 */
static inline void LPUART_SetOversamplingRatio(LPUART_Type *base,
...
void LPUART_SetBitCountPerChar(LPUART_Type *base,
		lpuart_bit_count_per_char_t bitCountPerChar, bool parity);
 ...
 */
void LPUART_SetParityMode(LPUART_Type *base,
...
static inline void LPUART_SetStopBitCount(LPUART_Type *base,
	...
	base->BAUD = (base->BAUD & ~LPUART_BAUD_SBNS_MASK)
			| ((uint32_t) stopBitCount << LPUART_BAUD_SBNS_SHIFT);
}
...
static inline void LPUART_SetTxDmaCmd(LPUART_Type *base, bool enable) {
	base->BAUD = (base->BAUD & ~LPUART_BAUD_TDMAE_MASK)
			| ((enable ? 1UL : 0UL) << LPUART_BAUD_TDMAE_SHIFT);
}
...
static inline void LPUART_SetRxDmaCmd(LPUART_Type *base, bool enable) {
	base->BAUD = (base->BAUD & ~LPUART_BAUD_RDMAE_MASK)
			| ((enable ? 1UL : 0UL) << LPUART_BAUD_RDMAE_SHIFT);
}
#endif
 ...
 */
bool LPUART_GetStatusFlag(const LPUART_Type *base,
