 ...
 */
static inline void PINS_SetPullSel(PORT_Type *const base, uint32_t pin,
 ...
 */
static inline void PINS_SetPinIntSel(PORT_Type *const base, uint32_t pin,
...
static inline port_interrupt_config_t PINS_GetPinIntSel(
		const PORT_Type *const base, uint32_t pin) {
	DEV_ASSERT(pin < PORT_PCR_COUNT);
	uint32_t regValue = base->PCR[pin];
 ...
 * @param[in] pin   port pin number
 */
static inline void PINS_ClearPinIntFlagCmd(PORT_Type *const base, uint32_t pin) {
	DEV_ASSERT(pin < PORT_PCR_COUNT);
	uint32_t regValue = base->PCR[pin];
 ...
 * @param[in] pin   port pin number
 */
static inline void PINS_EnableDigitalFilter(PORT_Type *const base, uint32_t pin) {
	DEV_ASSERT(pin < PORT_PCR_COUNT);
