 ...
 *         STATUS_ERROR if an error occurred
 */
status_t LPUART_DRV_SendDataBlocking(uint32_t instance, const uint8_t *txBuff,
 ...
 *          STATUS_BUSY if the resource is busy;
 */
status_t LPUART_DRV_SendDataPolling(uint32_t instance, const uint8_t *txBuff,
		uint32_t txSize);
 ...
 *         STATUS_BUSY if the resource is busy;
 */
status_t LPUART_DRV_SendData(uint32_t instance, const uint8_t *txBuff,
		uint32_t txSize);
 ...
 */
status_t LPUART_DRV_ReceiveDataBlocking(uint32_t instance, uint8_t *rxBuff,
 ...
 *         STATUS_BUSY if the resource is busy
 */
status_t LPUART_DRV_ReceiveData(uint32_t instance, uint8_t *rxBuff,
		uint32_t rxSize);
 ...
 */
status_t LPUART_DRV_SetTxBuffer(uint32_t instance, const uint8_t *txBuff,
		uint32_t txSize);
 ...
 * @return STATUS_SUCCESS
 */
status_t LPUART_DRV_SetRxBuffer(uint32_t instance, uint8_t *rxBuff,
		uint32_t rxSize);
